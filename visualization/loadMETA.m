function [I,dataType,origin,spacing] = loadMETA(filename, verbose)
%
...
for i=1:size(key,1)
  switch key{i}
   ...
   case 'ElementType'
     ...
     dataType = val{i}; % decideMETADataType(val{i});
...
[I,count] = fread(fid,prod(imSize)*numChannels,decideMETADataType(dataType));
fclose(fid);
